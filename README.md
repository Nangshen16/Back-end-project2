...
I will be creating a gorcery store for milennials. It will consist of a form where information on each customer can fill out whatever they want to the carts and then displayed in a seprate section. I will be using CRUD methods to create, read, update and delete ingredients on the shopping cart and gorcery using a full stack applications.
